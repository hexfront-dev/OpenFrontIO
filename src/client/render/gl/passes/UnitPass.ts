...
function createUnitVao(
  ...
  // Attribute 3: per-instance scale (uint8) at offset 14 — 0=1x, 1=1.5x, 2=2x
  gl.enableVertexAttribArray(3);
  gl.vertexAttribPointer(3, 1, gl.UNSIGNED_BYTE, false, BYTES_PER_INSTANCE, 14);
...
export class UnitPass {
  ...
  private emitGround(
    ...
    this.groundBuf.uint8[byteOff + 14] = scale;
    this.groundCount++;
  }
  ...
  private emitMissile(
    ...
    this.missileBuf.uint8[byteOff + 14] = scale;
    this.missileCount++;
  }
